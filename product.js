  ...
  btn.addEventListener("click", () => {
    ...
    <div class="product-modal">
      ...
      <div class="product-modal-info">
        ...
        <p class="product-price"> 4500 MKD </p>
        <a href="https://docs.google.com/forms/d/1i15hBW6t1cn4ZbNFB87Si8Lr25Xl6KP-YQnDym-l2zI/prefill" class="btn btn-main">Нарачај Веднаш</a>
      </div>
    </div>
    `;
